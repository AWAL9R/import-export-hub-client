  ...
  return (
    <div >
      <div className="fixed inset-0 min-h-screen  flex items-center justify-center z-50" style={{ backgroundColor: 'rgba(107,114,128,0.6)' }} onClick={onClose}>
        <div className="bg-white rounded shadow-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto relative px-6 py-3 transition-all mx-4" onClick={(e) => { e.stopPropagation(); }}>
          <button
            onClick={onClose}
